        ...
        tokens.extend(match self {
            ...
            Scope::PublicKey(pk) => {
                ...
                match pk.algorithm {
                    ...
                    Algorithm::Mldsa44 => quote! { ::biscuit_auth::builder::Scope::PublicKey(
                        ::biscuit_auth::PublicKey::from_bytes(&[#(#bytes),*], ::biscuit_auth::builder::Algorithm::Mldsa44).unwrap()
                      )},
                    Algorithm::Mldsa65 => quote! { ::biscuit_auth::builder::Scope::PublicKey(
                        ::biscuit_auth::PublicKey::from_bytes(&[#(#bytes),*], ::biscuit_auth::builder::Algorithm::Mldsa65).unwrap()
                      )},
                    Algorithm::Mldsa87 => quote! { ::biscuit_auth::builder::Scope::PublicKey(
                        ::biscuit_auth::PublicKey::from_bytes(&[#(#bytes),*], ::biscuit_auth::builder::Algorithm::Mldsa87).unwrap()
                      )},
                    Algorithm::Fndsa512 => quote! { ::biscuit_auth::builder::Scope::PublicKey(
                        ::biscuit_auth::PublicKey::from_bytes(&[#(#bytes),*], ::biscuit_auth::builder::Algorithm::Fndsa512).unwrap()
                      )},
                    Algorithm::Fndsa1024 => quote! { ::biscuit_auth::builder::Scope::PublicKey(
                        ::biscuit_auth::PublicKey::from_bytes(&[#(#bytes),*], ::biscuit_auth::builder::Algorithm::Fndsa1024).unwrap()
                      )},
                    Algorithm::Slhdsa128s => quote! { ::biscuit_auth::builder::Scope::PublicKey(
                        ::biscuit_auth::PublicKey::from_bytes(&[#(#bytes),*], ::biscuit_auth::builder::Algorithm::Slhdsa128s).unwrap()
                      )},
                    Algorithm::Slhdsa128f => quote! { ::biscuit_auth::builder::Scope::PublicKey(
                        ::biscuit_auth::PublicKey::from_bytes(&[#(#bytes),*], ::biscuit_auth::builder::Algorithm::Slhdsa128f).unwrap()
                      )},
                    Algorithm::Slhdsa256s => quote! { ::biscuit_auth::builder::Scope::PublicKey(
                        ::biscuit_auth::PublicKey::from_bytes(&[#(#bytes),*], ::biscuit_auth::builder::Algorithm::Slhdsa256s).unwrap()
                      )},
                    Algorithm::Slhdsa256f => quote! { ::biscuit_auth::builder::Scope::PublicKey(
                        ::biscuit_auth::PublicKey::from_bytes(&[#(#bytes),*], ::biscuit_auth::builder::Algorithm::Slhdsa256f).unwrap()
                      )},
                    Algorithm::HybridEdMldsa44 => quote! { ::biscuit_auth::builder::Scope::PublicKey(
                        ::biscuit_auth::PublicKey::from_bytes(&[#(#bytes),*], ::biscuit_auth::builder::Algorithm::HybridEdMldsa44).unwrap()
                      )},
                    Algorithm::HybridEdFndsa512 => quote! { ::biscuit_auth::builder::Scope::PublicKey(
                        ::biscuit_auth::PublicKey::from_bytes(&[#(#bytes),*], ::biscuit_auth::builder::Algorithm::HybridEdFndsa512).unwrap()
                      )},
